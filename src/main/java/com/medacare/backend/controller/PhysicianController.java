...
public class PhysicianController {
    ...
    public ResponseEntity<StandardResponse> getAllPhysicians() {
        ...
        return ResponseEntity.status(HttpStatus.OK)
                .body(responseService.createStandardResponse("success", physicians, "Physicians retrieved successfully",
                        null, HttpStatus.OK));
    }
    ...
    public ResponseEntity<StandardResponse> getPhysicianById(@PathVariable Long id) {
        ...
        return ResponseEntity.status(HttpStatus.OK)
                .body(responseService.createStandardResponse("success", physician, "Physician retrieved successfully",
                        null, HttpStatus.OK));
    }
    ...
    public ResponseEntity<StandardResponse> deletePhysician(@PathVariable Long id) {
        ...
        return ResponseEntity.status(HttpStatus.NO_CONTENT)
                .body(responseService.createStandardResponse("success", null, "Physician deleted successfully", null,
