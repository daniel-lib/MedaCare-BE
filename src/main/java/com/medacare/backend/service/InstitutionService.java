...
public class InstitutionService {
    ...
    public InstitutionService(InstitutionRepository institutionRepository, EmailService emailService,
            ...
            InstitutionFileRepository institutionFileRepository) {
    ...
    try {
        for (var file : institution.getFileUploads().entrySet()) {
            ...
            institutionFile.setFileDescription("Business Verification Document for " + savedInsitution.getName());
    ...
    public User createInstitutionAccount(Institution institution) {
        ...
        emailService.sendInstitutionAccountCreationEmail(user, generatedPassword);
